...
if (fs.existsSync(statePath)) {
  ...
  // Find directories that might contain 'codeKanban' or 'kanban'
  const possibleDirs = dirs.filter(
    (dir) => dir.includes("codeKanban") || dir.includes("kanban")
  );
  ...
  if (possibleDirs.length > 0) {
    ...
    console.log(
      "No matching directories found. Here are all available directories:"
    );
